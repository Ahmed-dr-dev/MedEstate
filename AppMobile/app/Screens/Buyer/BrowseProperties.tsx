...
const dubaiDeveloperHouses: Property[] = [
  {
    ...
    description: 'Stunning waterfront villa with private beach access and panoramic views of the Arabian Gulf. Features modern architecture with premium finishes.',
    price: 8500000,
  ...
  },
  {
    ...
    description: 'Contemporary apartment in the heart of Dubai with Burj Khalifa views and premium amenities. Perfect for urban living.',
    price: 3200000,
  ...
  },
  {
    ...
    description: 'Exclusive penthouse with private terrace overlooking Dubai Marina and the Arabian Gulf. Luxury living at its finest.',
    price: 12000000,
...
const esgaiherTunisiaHouses: Property[] = [
  {
    ...
    description: 'Villa contemporaine avec vue sur la mer Méditerranée et architecture traditionnelle tunisienne. Idéale pour une résidence secondaire.',
    price: 450000,
  ...
  },
  {
    ...
    description: 'Appartement haut de gamme dans le quartier historique de Carthage avec vue sur les ruines antiques. Patrimoine et modernité.',
    price: 320000,
  ...
  },
  {
    ...
    description: 'Villa spacieuse pour famille avec jardin privé et piscine, proche des plages de La Marsa. Parfait pour les familles.',
    price: 680000,
...
export default function BrowseProperties() {
  ...
  const filteredAndSortedProperties = useMemo(() => {
    let filtered = properties.filter(property => {
      ...
      const matchesFilter = selectedFilter === 'all' || 
                           property.property_type.toLowerCase() === selectedFilter.toLowerCase();
  ...
  const showSortOptions = () => {
    Alert.alert(
      'Sort Properties',
      'Choose how to sort the properties',
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerText}>
              ...
              <Text style={styles.subtitle}>Discover amazing properties</Text>
            </View>
          </View>
        </View>
